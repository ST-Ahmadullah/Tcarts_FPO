...
//		performMouseAction("click", pom.getInstancedb().getFullscreen());
		...
		waitForElement("static", 3000, null);
		 ...
		 WebElement searchElement = driver.findElement(By.xpath("//td[@class='fw-bold sorting_1']"));
		 String actual1 = searchElement.getText();
	...
	@Test(dependsOnMethods = { "users" }, priority = 2)
...
//		performMouseAction("click", pom.getInstancedb().getFullscreen());
	...
	@Test(dependsOnMethods = { "users" }, priority = 3)
...
//		performMouseAction("click", pom.getInstancedb().getFullscreen());
	...
	@Test(dependsOnMethods = { "users" }, priority = 4)
	private void guest() {
